...
export default function NewListingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : "Failed to create listing. Please check if the listings table exists in your Supabase database."
      ...
      <main className="min-h-screen bg-background">
        <div className="max-w-3xl mx-auto px-4 py-16">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">List your vintage item for sale</p>
          </div>
          ...
          {success && (
            <div className="bg-green-50 text-green-800 border border-green-200 px-4 py-3 rounded-lg mb-6 flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-sm">Your listing has been created. Redirecting to dashboard...</p>
              </div>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="card p-8 space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                required
                placeholder="Describe the item, its condition, measurements, etc."
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary bg-background"
                placeholder="e.g., Denim, Outerwear, Accessories"
              />
            </div>
